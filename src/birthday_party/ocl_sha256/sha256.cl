...
// Generic version that works for any HASH_TOTAL_BYTES (5-27)
// Min 5 bytes for sufficient entropy, max 27 bytes ensures ASCII (54 chars) + padding fits in single 64-byte SHA256 block
